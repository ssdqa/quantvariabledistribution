...
when the `pcornet` CDM is selected. The user should recreate this file
and include their own value definitions.
...
- vocabulary_field:
  ...
  *character* \| the name of the column where the vocabulary type
  associated with the concepts are stored (typically dx_type or px_type,
  where needed)
